...
character.greet = function() {
    alert(`I am ${character.surName} and my title is ${character.title}`);
}
...
character.greet = function() {
    alert(`She is ${character.surName} and her title is ${character.title}`);
}
...
character.changeIsAdult = function() {
    return character.changeIsAdult = !character.isAdult;
}
...
keyName[keyName="Maisie Williams"];
