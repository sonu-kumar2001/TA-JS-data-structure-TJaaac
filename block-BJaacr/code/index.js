...
for(let peoples of got.houses[1].people) {
  console.log(peoples.name,peoples.description);
}
...
let obj = {};
for (let peoples of got.houses) {
  obj[peoples.name] = peoples.people.length;
}
console.log(obj);
...
let allDescription = [];
allDescription.push(allPeople,allPeople.length);
